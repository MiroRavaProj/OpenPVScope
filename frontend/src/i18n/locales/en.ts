...
export const en: Dict = {
  ...
  alignment: {
    ...
    savedBody:
      "Parameters below are restored from the project. You can review the split compare or re-run alignment.",
    intro:
      "Automatic AKAZE → TPS registration warps the thermal orthophoto so it lines up with RGB in map space. Pass 1 is a global affine (tile phase + AKAZE + ECC); Pass 2 is local metre-tile TPS. Registration uses a working grid capped at the max GSD (default 2 cm).",
    statusDone: "· status: done",
    resetDefaults: "Reset defaults",
    reviewOverlay: "Review split view",
    ...
    paramLocalMax: "Local max (m)",
    paramTile: "Tile size (m)",
    paramStride: "Stride (m)",
    ...
    modalHint: "RGB left · thermal right. Drag the divider, pan, and scroll to zoom.",
    modalLoadingTiles: "Loading tiles…",
    modalBack: "Back",
    modalSave: "Save alignment",
    modalSaving: "Saving…",
    modalThermalOpacity: "Thermal opacity {{pct}}%",
    thermalOnly: "Thermal only",
    splitDrag: "Drag to compare",
    metaSummary: "{{runtime}}s · {{pass1}} · {{ctrl}} TPS tiles · work {{workGsd}} cm/px",
